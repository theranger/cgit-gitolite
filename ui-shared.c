...
void cgit_print_docend(void)
{
	...
	if (ctx.cfg.footer)
		...
		htmlf("<div class='footer'>generated by <a href='http://git.zx2c4.com/cgit/about/'>cgit %s</a> "
				"with <a href='http://ivari.risk.ee/projects/cgit-gitolite'>gitolite patch</a> at ", cgit_version);
