...
void cgit_print_docend(void)
{
	...
	if (ctx.cfg.footer)
		...
		htmlf("<div class='footer'>generated by <a href='https://git.zx2c4.com/cgit/about/'>cgit %s</a> ", cgit_version);
		htmlf("with <a href='http://ivari.risk.ee/projects/cgit-gitolite'>gitolite patch %s</a> at ", cgit_gitolite_version);
